...
public class AllserviceReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDoalog = new ProgressDialog(AllserviceReport.this);
        ...
        if(city.equals("ahmedabad")| city.equals("vadodara") | city.equals("surat") | city.equals("rajkot") | city.equals("gandhinagar")) {
            ...
            Call<List<Showyourrequeststatus>> calllocation = service.showyourallservice(payerReg);
            calllocation.enqueue(new Callback<List<Showyourrequeststatus>>() {
                ...
                public void onFailure(Call<List<Showyourrequeststatus>> call, Throwable t) {
                    Toast.makeText(AllserviceReport.this, "something went wrong", Toast.LENGTH_SHORT).show();
                }
            });
        }else {
...
//        });
    ...
    private void generateDataList(List<Showyourrequeststatus> photoList) {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(AllserviceReport.this);
